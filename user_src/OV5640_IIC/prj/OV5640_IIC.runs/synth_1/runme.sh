...
HD_PWD='F:/MZ7015FA/XMDA_LINUX/CH09_OV56402PC/FPGA/pcie_system/user_src/OV5640_IIC/prj/OV5640_IIC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OV5640IIC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OV5640IIC.tcl
