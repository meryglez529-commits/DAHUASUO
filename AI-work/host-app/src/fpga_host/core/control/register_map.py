...
REGISTER_SPECS: dict[int, RegisterSpec] = {
    ...
    0x000F: RegisterSpec(0x000F, "dax_fall_time", default=0),
    ...
    0x0014: RegisterSpec(0x0014, "row_m_n", default=0x00010001),
    0x0200: RegisterSpec(0x0200, "sync1_pixel_tri_width", readable=False, writable=True, default=0),
    0x0201: RegisterSpec(0x0201, "adc_acq_delay", readable=False, writable=True, default=0),
    0x0202: RegisterSpec(0x0202, "ultrafast", readable=False, writable=True, default=0),
    0x0203: RegisterSpec(0x0203, "sync_signal_delay", readable=False, writable=True, default=0),
    0x0204: RegisterSpec(0x0204, "acq_dead_time", readable=False, writable=True, default=0),
    0x0205: RegisterSpec(0x0205, "laser_mode_en", default=0),
...
DUMP_RANGES: dict[str, list[int]] = {
    "basic": [0x0000, 0x0001, 0x0002, 0x0004, 0x0009, 0x000A],
    "dl5": [0x0205, 0x0206, 0x0207, 0x0208, 0x0209, 0x020A],
}
