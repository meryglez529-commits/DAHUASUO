...
set ila [get_hw_ilas hw_ila_9]
if {$ila eq ""} {
    error "Could not find hw_ila_9 / U5/adcdata1_acq/test"
}

set trig [get_hw_probes U5/adcdata1_acq/adc_tri_r1 -of_objects $ila]
if {$trig eq ""} {
    error "Could not find U5/adcdata1_acq/adc_tri_r1 probe"
}
...
file mkdir $ila_out
set csv_file [file join $ila_out "dl5_adc1_acq_capture.csv"]
set vcd_file [file join $ila_out "dl5_adc1_acq_capture.vcd"]
