...
if {$ila eq ""} {
    error "Could not find hw_ila_18 / U6/N2 dl5_acq_timing_test"
}

set trig [get_hw_probes U6/N2/laser_pulse_ui_1 -of_objects $ila]
if {$trig eq ""} {
    error "Could not find U6/N2/laser_pulse_ui_1 probe"
}
...
file mkdir $ila_out
set csv_file [file join $ila_out "dl5_acq_timing_capture.csv"]
set vcd_file [file join $ila_out "dl5_acq_timing_capture.vcd"]
